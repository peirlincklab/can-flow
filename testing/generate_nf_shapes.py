...
for str, mod in zip(models_str, models):
    ...
    save_write_momenta.save_momenta(type_momenta="Female_genTest" + "_" + str, momenta_tosave=generated_female)
    save_write_momenta.save_momenta(type_momenta="Male_genTest" + "_" + str, momenta_tosave=generated_male)
