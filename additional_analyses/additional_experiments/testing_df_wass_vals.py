...
def generate_plot(df, df_str, color_plot, xmin, xmax, ymin, ymax, df_real_overlay=None):
    ...
    # ax_scatter.set_yticks(np.linspace(ymin, ymax, 5, dtype=int))
    ...
    plt.savefig(f'../figures_experiments/compare_clinical_metrics/{df_str}_myo_mass_g.svg')
    # plt.show()
...
models = ['real', 'can_do', 'cvae2', 'cvae3']
