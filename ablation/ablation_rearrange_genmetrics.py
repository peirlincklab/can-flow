...
def copy2clean(model_str, all_num, model_str_path):
    ...
    os.makedirs(fr"C:\Users\kkevopoulos\Documents\Meshes_Anatomies\Gen_Metrics_Exp_Files_Ablation\{model_str}_PCs", exist_ok=True)
    ...
    for i in range(all_num):
        ...
        new_folder_path =  fr"C:\Users\kkevopoulos\Documents\Meshes_Anatomies\Gen_Metrics_Exp_Files_Ablation\{model_str}_PCs/PointCloud_{i}.vtk"
...
os.makedirs( r"C:\Users\kkevopoulos\Documents\Meshes_Anatomies\Gen_Metrics_Exp_Files_Ablation", exist_ok=True)
