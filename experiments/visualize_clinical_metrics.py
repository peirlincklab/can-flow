...
rv_vol_vae = df_vae['RV_Vol_mL']
lv_vol_vae = df_vae['LV_Vol_mL']
...
ax_scatter.scatter(rv_vol_nf, lv_vol_nf, s=5, color='aqua', label='NF')
ax_scatter.scatter(rv_vol_vae, lv_vol_vae, s=5, color='tab:orange', label='VAE')
ax_scatter.scatter(rv_vol_gan, lv_vol_gan, s=5, color='tab:red', label='GAN')
...
sns.kdeplot(x=rv_vol_vae, ax=ax_histx, fill=True, color='tab:orange')
sns.kdeplot(x=rv_vol_gan, ax=ax_histx2, fill=True, color='tab:red')

### Right KDE -> For LV
sns.kdeplot(y=lv_vol_real, ax=ax_histy, fill=True, color='tab:grey')
sns.kdeplot(y=lv_vol_nf, ax=ax_histy, fill=True, color='aqua')
sns.kdeplot(y=lv_vol_vae, ax=ax_histy, fill=True, color='tab:orange')
sns.kdeplot(y=lv_vol_gan, ax=ax_histy2, fill=True, color='tab:red')
